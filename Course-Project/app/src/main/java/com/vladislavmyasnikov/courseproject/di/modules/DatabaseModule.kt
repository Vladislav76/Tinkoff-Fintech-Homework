...
class DatabaseModule {
    ...
    @Provides
    @Singleton
    fun provideDatabase(@Named("application_context") context: Context, @Named("database_name") name: String) = Room.databaseBuilder(context, LocalDatabase::class.java, name).build()
}